...
function pricingTree(lob, market) {
  ...
  const sop = isGoods
    ...
    : <>Local / National (INTL) : <b>pas de seuil de 40 %</b>. Toujours tenter de valider via le site ou un PV. Comparer le prix public au prix SF (et à l'amendement signé le cas échéant). Site inférieur à SF → <b>IR</b>. Pas de prix public → champ Proof of Pricing en SF.{convNote}</>;
  ...
  const nodes = {
    ...
    q_goods_pv: {
      ...
      opts: [
        { t: "Oui — PV présent, Unit Value inférieure ou égale au PV", tone: "ok", go: "pvv_start" },
    ...
    q_local_site_lowdisc: {
      ...
      opts: [
        ...
        { t: "Site inférieur à SF (ou inférieur à l'amendement)", tone: "warn", go: "r_ir_local" },
      ],
    },
    q_local_site: {
